      ...
      <v-col cols="12" sm="12" md="6" lg="4">
        <div class="filter-block">
          <div style="width: 100%">
            ...
            <h3 class="mt-12 mb-5">Employee</h3>
            <v-select
...
import ENV from "~/OLD_env";
  ...
  export default {
    ...
    methods: {
      ...
      async chooseEmployee(employee) {
        await this.getTransactionsByEmployee(employee.number)
      },
      async getTransactionsByEmployee(employeeNumber) {
        this.loading = true;
        this.transactions = []
        await this.$axios.$post(`${ENV.backendUrl}/get-staff-transactions`, {
